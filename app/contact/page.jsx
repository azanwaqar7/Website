...
const info = [
    {
        icon: <FaPhoneAlt />,
        title: "Phone",
        description: "(+92) 3454553100"
    },
    {
        icon: <FaEnvelope />,
        title: "Email",
        description: "azanwaqar7@gmail.com"
    },
    {
        icon: <FaMapMarkerAlt />,
        title: "Address",
                    ...
                    <Select>
                        ...
                        <SelectContent>
                            <SelectGroup>
                                ...
                                <SelectItem value = "cst">Database Management</SelectItem>
                                <SelectItem value = "mst">SQL Programming</SelectItem>
                                <SelectItem value = "lst">Python Programming</SelectItem>
                            </SelectGroup>
                        </SelectContent>
                    </Select>
                    {/*textarea */}
