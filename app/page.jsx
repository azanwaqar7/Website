...
const Home = () => {
  return ( <section className = "h-full">
      ...
      <div className = "container mx-auto h-full"> {/* This aligns homepage with the Azan at the top means it aligns within the container */}
          <div className ="flex flex-col xl:flex-row items-center justify-between xl:pt-8 xl-pb-24">
            {/* text */}
            <div className ="text-center xl:text-left order-2 xl:order-none">
              <span className="text-xl">Data Analyst</span>
                <h1 className = "h1 mb-6">
                  Hello I'm <br /> <span className ="text-accent">Azan Waqar</span>
                </h1>
                <p className="max-w-[500px] mb-9 text-white/80">
                  I excel at crafting elegant digital experiences and I am proficient 
                  in various programming languages and data visualization technologies
                </p>
                {/* btn and socials*/}
                <div className="flex flex-col xl:flex-row items-center gap-8">
                <a href = "/assets/work/Azan's Resume.pdf" download>
                    <Button 
                    variant = "outline" 
                    size = "lg" 
